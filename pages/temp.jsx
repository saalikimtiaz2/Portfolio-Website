      ...
      <Layout>
        <section className={Styles.heroSection}>
          <div className='lg:container lg:mx-auto p-4'>
            <div className='grid grid-cols-12 items-center xs:gap-y-16 lg:gap-y-0'>
          ...
          <h2 className={Styles.stylishHeading}>Salik Imtiaz</h2>
        </section>
        <section>
          <div className='lg:container lg:mx-auto xs:px-4 md:px-16 lg:px-'>
            <div className='grid grid-cols-12 xs:gap-0 lg:gap-10 items-center'>
              ...
              <div className='xs:col-span-12 md:col-span-6 lg:col-span-5 flex flex-col items-center justify-center'>
                <div
                  className={`${Styles.card} shadow-lg hover:shadow-xl ${
                    darkMode && 'bg-darkCard'
                  }`}
                >
                  <Developer />
                  <h1
                ...
                <div
                  className={`${Styles.card} mt-6 shadow-lg hover:shadow-xl ${
                    darkMode && 'bg-darkCard'
                  }`}
                >
                  <UIUX />
