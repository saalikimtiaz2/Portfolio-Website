...
import { Coffee, Facebook, Github, Instagram, Linkedin, Twitter } from '../components/SvgIcons';
...
function Home() {
	...
	return (
		<div>
			<Head>
				<title>Salik Imtiaz | MERN Stack Developer</title>
			...
			<Layout>
					...
					<div className="xs:px-4 lg:px-20 pt-4 ">
						<div className="grid grid-cols-12 xs:gap-y-10 lg:gap-10 ">
							<div className="xs:col-span-12 lg:col-span-8 relative flex xs:flex-col lg:flex-row lg:items-end">
								<img src="/assets/hero.svg" alt="" className={Styles.heroImage} />
								<h2 className={Styles.title}>
									Salik Imtiaz
									<img src="/assets/icons/right-arrow.svg" alt="" className="xs:h-12 lg:h-20" />
								</h2>
							</div>
							<div className="xs:col-span-12 lg:col-span-4 xs:pt-0 lg:pt-10 flex flex-col justify-between gap-y-20">
								<div>
									...
									<p className="max-w-35 mt-8 text-16 text-gray">
										As a MERN Stack developer, I have a strong foundation in web development and a passion for building
										user-friendly and visually appealing web applications. I am constantly learning and staying
										up-to-date on the latest technologies (such as React Js, Next Js, Vite Js, Node Js, Express Js,
										MongoDB, Javascript, Typescript, WebRTC, Sanity CRM, AWS and Restful API&apos;s) in the field to
										ensure that I am able to deliver high-quality products to my clients.
									</p>
									<button
				...
				<section className={`pb-24 ${darkMode ? 'bg-darkCard' : 'bg-grayBg'}`}>
					<div className="xs:px-4 lg:px-0 lg:container lg:mx-auto pt-24" id="about" ref={aboutRef}>
						<div className="grid grid-cols-12 xs:gap-y-20 lg:gap-6 mb-10 items-center">
							<div className="xs:col-span-12 lg:col-span-6 relative">
								<h2 className={`stylishHeading -rotate-10 text-center ${darkMode ? 'text-darkGray' : 'text-gray'}`}>
									About.
								</h2>
                    ...
                    <h2 className="text-20 max-w-10">Satisfied clients.</h2>
							...
							<div className="xs:col-span-12 lg:col-span-6">
								...
								<h2 className="max-w-45">
									Experienced MERN Stack Developer adept in bringing forth expertise in web systems.
								</h2>
							</div>
						</div>
						<h4 className="mt-12 text-24 mb-4 text-center">- Where I’ve Worked</h4>
						<div className="grid grid-cols-12 gap-4">
							<div className="xs:col-span-12 lg:col-span-4">
								<h5 className="max-w-55 text-[18px] mt-2 text-secondary">
									...
									<span className="block text-[14px]">Code Huddle, Islamabad</span>
								</h5>
								<p className="max-w-55 font-light text-[10px]">DECEMBER 2022 - Present</p>
								<ul className="pl-8 text-[12px] max-w-[55ch] list-disc py-4 font-light">
									<li>Developed and Shipped the fronted features of live Gym training application.</li>
									<li>
										Incorporated TS into an existing JS project which helped improve the developer experience and
										reliability of the application.
									</li>
									<li>
										Collaborated with cross-functional teams, including designers, project managers, and back-end
										developers, to deliver successful projects on time.
									</li>
									<li>
										Led the front-end development of a customer service platform, including the implementation of
										responsive design and the integration of various APIs.
									</li>
								</ul>
							</div>
							<div className="xs:col-span-12 lg:col-span-4">
								...
								<p className="max-w-55 font-light text-[10px]">DECEMBER 2021 - NOVEMBER 2022</p>
								<ul className="pl-8 text-[12px] max-w-[55ch] list-disc py-4 font-light">
									<li>
										Incorporated name of library in to the above mentioned application which enabled trainers and
										instructors to communicate in real time which helped increase the subscription rate by 35%
									</li>
									<li>Developed the frontend prototype for an AI SASS that helped user write better content.</li>
									<li>
										Migrated an old metior based library to next improving the build time from 12 mins to 2.8 minutes
										which resulted in dropping the build cost by 70%
									</li>
							...
							<div className="xs:col-span-12 lg:col-span-4">
								<h5 className="max-w-55 text-[18px] mt-2 text-secondary">
									Frontend Developer,
									<span className="block text-[14px]">The Web Agency, Islamabad</span>
								</h5>
								<p className="max-w-55 font-light text-[10px]">APRIL 2020 - Present</p>
								<ul className="pl-8 text-[12px] max-w-[55ch] list-disc py-4 font-light">
                ...
                <button className="text-24 text-primary flex items-center gap-4 mt-4 btn~ btn-down">
                  ...
                  />
					...
					<div id="techStack" className="py-16">
						<h2 className={`stylishHeading text-center mt-20 ${darkMode ? 'text-darkGray' : 'text-gray'}`}>
							Tech Stack.
						</h2>
						...
						<div className="lg:container lg:mx-auto flex items-center flex-wrap justify-center xs:gap-10 lg:gap-x-20 mt-20">
							{icons.map(icon => (
								<div
									...
									} px-3 py-2 gap-4 rounded-md xs:h-18 xs:w-18
                   lg:h-24 lg:w-24 flex flex-col items-center trasition duration-700 ${Styles.techCard}`}
									key={icon.name}
								>
									{darkMode ? (
										<img src={icon.darkImage} alt="" className="xs:h-[2rem] lg:h-12" />
									) : (
										<img src={icon.image} alt="" className="xs:h-[2rem] lg:h-12" />
									)}
									<p className="xs:text-12 lg:text-14 text-center pb-0">{icon.name}</p>
            ...
            <div className="grid grid-cols-12 mt-20 xs:gap-4 lg:gap-10 items-center">
              ...
              <div className="xs:col-span-12 lg:col-span-7 flex flex-wrap items-center gap-6 xs:justify-center lg:justify-end">
					...
					<div className="lg:container lg:mx-auto xs:px-4 lg:px-0">
						<div className="grid grid-cols-12 items-center justify-center">
							<div className="xs:col-span-12 lg:col-span-5">
								...
								<p className="max-w-40 mt-8 text-14 text-gray">
									Some seletive project chosen by me. I have completed these projects with some amazing people from
									different companies.
								</p>
							</div>
						...
						<div className="grid grid-cols-12 gap-4 xs:mt-10 lg:mt-32 mb-6">
							{Projects.map(project => (
								<div key={project.name} className="xs:col-span-12 sm:col-span-4 md:col-span-3 lg:col-span-2">
				...
				<section className={`lg:py-32 ${darkMode ? 'bg-darkCard' : 'bg-grayBg'}`} id="contact">
					<Contact />
				</section>
			</Layout>
		</div>
